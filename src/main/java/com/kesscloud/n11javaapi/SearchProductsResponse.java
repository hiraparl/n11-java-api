 ...
 *         &lt;element name="products" type="{http://www.n11.com/ws/schemas}ProductBasicList"/&gt;
...
@XmlRootElement(name = "SearchProductsResponse")
public class SearchProductsResponse {

    @XmlElement(required = true)
    protected ResultInfo result;
    @XmlElement(required = true)
    protected ProductBasicList products;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link ProductBasicList }
     *     
     */
    public ProductBasicList getProducts() {
        return products;
    }
     ...
     *     
     */
    public void setProducts(ProductBasicList value) {
        this.products = value;
    }
